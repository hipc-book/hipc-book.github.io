...
Now that we have covered the basics of the C programming language, and a little on scientific computing, the remaining sessions will be a little different. 

The remaining 7 practicals will be far less guided, instead focusing on a few simple applications that can be optimised and parallelised for a High Performance Computing platform. 
...
Attached File: [`spheres.c`](../../assets/practical-4/spheres.c)
...
![Intel Advisor Opening Screen](../../assets/practical-4/intel-advisor-1.png)  
...
![Creating a project in Intel Advisor](../../assets/practical-4/intel-advisor-2.png)  
...
![Vectorizations and Code Insights](../../assets/practical-4/intel-advisor-4.png)  
...
![Analysis workflow, choosing accuracy leve](../../assets/practical-4/intel-advisor-5.png)  
_**Figure 5:** Analysis workflow, choosing accuracy level_
{: style="color:gray; font-size: 90%; text-align: center;" }

![Intel Advisor Opening Screen](../../assets/practical-4/intel-advisor-6.png)  
...
![Performing a Roofline Analysis in Intel Advisor](../../assets/practical-4/intel-advisor-8.png)  
...
> # Bonus Exercise 
>
> Attached File: [`nbody.c`](../../assets/practical-4/nbody.c)
>
