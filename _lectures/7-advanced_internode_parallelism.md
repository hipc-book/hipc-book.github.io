...
<iframe width="560" height="315" class="center" src="https://www.youtube.com/embed/w37kM4Q0G-Y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe><br/>

In this unit, we're going to build on the previous unit, covering some of the more complex functionality in the MPI standard.
...
![12 processes arranged in a 3 x 4 grid, periodic in one dimension](../../assets/unit-7/cartgrid.png){: style="background:white;" }  
...
Our application is now able to calculate the neighbours on either side (in the _x_-dimension) in a single function call (and the call handles non-periodic boundaries). 
...
```c
int dims[2] = { 0, 0 }; // Dims_create will only change dimensions with value 0.
...
![An example file view on 4 processes](../../assets/unit-7/mpi-file-view.png){: style="background:white;" }  
