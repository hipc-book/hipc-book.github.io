...
<iframe width="560" height="315" class="center" src="https://www.youtube.com/embed/GofITv0ebSQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe><br/>
...
The stored-program computer architecture was a concept conceived by Alan Turing in 1936, as a universal Turing machine. This concept was formalised by John von Neumann and others in 1945 in the [_First Draft of a Report on the EDVAC_](https://en.wikipedia.org/wiki/First_Draft_of_a_Report_on_the_EDVAC), and was implemented on the EDVAC in 1949. 

![The von Neumann Architecture](../../assets/unit-2/vonneumann.png){: style="background-color:white" }  
...
![Basic block diagram for a simple single core CPU](../../assets/unit-2/CPUArch.png){: style="background-color:white" }  
...
![Simple vector pipeline](../../assets/unit-2/pipeline.png){: style="background-color:white" }  
...
<iframe width="560" height="315" class="center" src="https://www.youtube.com/embed/qm_CN1-c1r4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe> 
...
![A 3 by 3 torus network](../../assets/unit-2/torus.png){: style="background-color:white" }  
...
![A simple dragonfly topology](../../assets/unit-2/dragonfly.png){: style="background-color:white" }  
...
<iframe width="560" height="315" class="center" src="https://www.youtube.com/embed/1O_mFqFAhSw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe><br/>
